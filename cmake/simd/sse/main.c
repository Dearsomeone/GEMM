...
int main(int argc, char** argv)
{
	...
	size = N * N;
	/* 分配内存空间 */
	A = (float*)_mm_malloc(sizeof(float) * size, 16);
	B = (float*)_mm_malloc(sizeof(float) * size, 16);
	C = (float*)_mm_malloc(sizeof(float) * size, 16);
	timeData = (float*)_mm_malloc(sizeof(float) * batchSize, 16);
